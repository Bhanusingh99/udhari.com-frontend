  ...
  return (
    <div className="w-[33%]">
      <Sheet>
        ...
        <p className="py-2 px-2 bg-green-500 text-white font-semibold rounded-xl w-[90%] flex 
        justify-center cursor-pointer hover:bg-green-600 hover:text-white duration-200">GET ON CASH</p>
        </SheetTrigger>
          ...
          <SheetHeader>
            ...
            <SheetDescription className="">
                ...
                <div className="w-full mt-10 cursor-pointer ">
                    <p 
                    className="bg-green-500 text-white py-2.5 px-4 border-[1px] border-black
